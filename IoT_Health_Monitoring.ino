...
String SendHTML(float BPM, float SpO2, float temp) {
  ...
  ptr += "body { background-image: url(https://images.collegedunia.com/public/reviewPhotos/564393/1000050933.jpg?mode=cover); background-size: cover; font-family: sans-serif; color: #333333; font: 14px Helvetica, sans-serif box-sizing: border-box;}";
  ...
  ptr += "<h1>IoT BASED HEALTH MONITORING SYSTEM</h1>";    
